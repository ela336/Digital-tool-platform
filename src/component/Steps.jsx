...
const Steps = () => {
    return (
        ...
        <div className='bg-[#F9FAFC] text-center p-16 space-y-4 mt-16'>
            ...
            <p className='text-[26px] text-[#627382]'>Start using premium digital tools in minutes, not hours.</p>
            <div className='flex items-center justify-evenly gap-2 mt-12 container mx-auto p-3 '>
        ...
        <div className=' text-center p-16 space-y-4 mt-16'>
            <h2 className='font-extrabold text-[48px]'>Simple, Transparent Pricing</h2>
            <p className='text-26px] text-[#627382]'>Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
