      ...
      <div className='bg-[#F9FAFC] text-center p-16 space-y-4 mt-16'>
        ...
        <div className='flex flex-col md:flex-row md:items-center justify-evenly  gap-4 md:gap-2 mt-12 container  md:mx-auto  md:p-3  '>
          <div className='shadow rounded-3xl bg-white py-8 px-4 space-y-3 '>
            ...
            <div className='w-23 h-23 flex items-center justify-center rounded-full mx-auto bg-[#dbcae8]'><img src={userimage} alt="" /></div>
          ...
          <div className='shadow rounded-3xl bg-white py-8  px-4 space-y-3 '>
            ...
            <div className='w-23 h-23 flex items-center justify-center rounded-full mx-auto bg-[#dbcae8]'><img src={packageimg} alt="" /></div>
          ...
          <div className='shadow rounded-3xl bg-white py-8 px-4 space-y-3 '>
            ...
            <div className='w-23 h-23 flex items-center justify-center rounded-full mx-auto bg-[#dbcae8]'><img src={rocketimg} alt="" /></div>
